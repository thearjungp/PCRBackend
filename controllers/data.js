...
const { enabledStockNamesOnly } = require('./stockentry');
...
const enabledStockNamesOnlyAsync = async () => {
    return await enabledStockNamesOnly();
}

let indices = enabledStockNamesOnlyAsync();
